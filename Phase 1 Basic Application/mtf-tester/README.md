...
- 🔐 **Multi-user authentication** — bcrypt password hashing, Fernet-encrypted MT5 credentials
...
1. Copy `.env.example` to `.env` and set your `FERNET_KEY`
2. Install dependencies: `pip install -r requirements.txt`
3. Install MetaTrader5 (Windows): `pip install MetaTrader5`
4. Start: `cd backend && python -m uvicorn main.app:app --host 127.0.0.1 --port 8000`
5. Open `http://127.0.0.1:8000/auth` to create an account
